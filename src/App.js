...
const QuoteTool = () => {
  ...
  const ProgressSteps = () => (
    <div className="max-w-full md:max-w-2xl mx-auto flex flex-col md:flex-row items-center justify-between mb-12 pt-8">
      {[
        ...
        <React.Fragment key={s.num}>
          ...
          {i < 2 && (
            <div className={`flex-1 h-px my-4 md:my-0 md:mx-4 ${step > s.num + 1 ? 'bg-teal-500' : 'bg-gray-200'}`} />
          )}
        </React.Fragment>
      ))}
    </div>
  ...
  const UseCaseStep = () => (
    <div className="max-w-2xl mx-auto px-6">
      <h1 className="text-xl md:text-2xl font-semibold mb-8">Select your use case</h1>
  ...
  const ProductStep = () => (
    <div className="max-w-2xl mx-auto px-6">
      <div className="flex items-center mb-8">
        ...
        <h1 className="text-xl md:text-2xl font-semibold">Select your products</h1>
      </div>
  ...
  const ConfigureStep = () => (
    <div className="flex flex-col lg:flex-row gap-8 px-6 max-w-5xl mx-auto">
